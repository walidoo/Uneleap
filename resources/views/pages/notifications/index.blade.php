        ...
        <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                <div class="mailbox-controls">
                    <button type="button" class="btn btn-default btn-sm"><a href="/user/notifications" class="fa fa-refresh"></a></button>
                    <!-- /.pull-right -->
                </div>
                    ...
                    <table class="table table-hover table-striped">
                        <tbody>
                            ...
                            <tr id="message-row">
                                ...
                                <td class="mailbox-name"><a href="{{$notification['href']}}">{{$notification->title}}</a></td>
