                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div  id="universityPageContent" style="width: 80%;
                                  margin-left: 10%;">
...
<script type="text/javascript">
    ...
    $(".js-data-example-ajax").change(function () {
        ...
        callback_urgencyAdminJdReport.add(function takeAction(response)
        {
            ...
            {
                $("#universityPageContent").html(response['data']);
                jQuery('#universityBasicInfoStore').validationEngine();
            }
        });
        var response = AjaxModule.postRequestReturnResponse('/admin/university/basicInfo', 'POST', params, callback_urgencyAdminJdReport);
        return false;
    });
</script>
