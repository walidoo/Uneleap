            ...
            <div class="box-tools">
                ...
                @if($data['type'] == "Question")
                    @if( $user->id == $data['item']->user_id )
                        <button onClick="editQuestion('{{ \encrypt(  $data['item']->id ) }}')" type="button" class="btn btn-box-tool" data-toggle="tooltip" title="Edit">
                            <i class="fa fa-edit"></i>
                        </button>
                        <button onClick="deleteQuestion('{{\encrypt( $data['item']->id )}}');" type="button" class="btn btn-box-tool"  data-toggle="tooltip" title="Delete">
